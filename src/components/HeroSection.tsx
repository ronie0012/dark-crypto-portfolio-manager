        ...
        <section className="overflow-hidden bg-white dark:bg-transparent">
          <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              <h2 className="">Smart Crypto Portfolio Management</h2>
              <p className="mx-auto my-8 max-w-2xl text-lg">
                Track, analyze & optimize your crypto investments in one place.
                Advanced analytics for smarter trading decisions.
              </p>

              <Button asChild size="lg">
                <Link href="/sign-up">
                  <span className="btn-label">Start Trading</span>
                </Link>
              </Button>
            </div>
          </div>
        ...
        <section className="bg-background relative z-10 py-16">
          <div className="m-auto max-w-5xl flex flex-col items-center mt-16 px-6">
            <h2 className="text-center text-2xl font-medium">
              Trusted by leading crypto exchanges worldwide.
            </h2>
